...
[nx ny nz ncoils nrots] = size(reconStruct.b1_mat);
npix = nx*ny*nz;    
...
if parallel.gpu.GPUDevice.isAvailable       
    ...
    %%%%%%%%%%%%%%%%%%%%%%
    %%changed 11/22/19    
    reconStruct_small.reconx = size(reconStruct.XX,1);
    reconStruct_small.recony = size(reconStruct.XX,2);
    reconStruct_small.I = reconStruct.I;
    %%%%%%%%%%%%%%%%%%%%%%
